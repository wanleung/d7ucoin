...
If it is a simple/trivial/non-controversial change, then one of the D7ucoin
development team members simply pulls it.

If it is a *more complicated or potentially controversial* change, then the patch
submitter will be asked to start a discussion (if they haven't already) on the
[mailing list](https://lists.linuxfoundation.org/mailman/listinfo/d7ucoin-dev)
...
completely stable. [Tags](https://github.com/d7ucoin/d7ucoin/tags) are created
regularly to indicate new official, stable release versions of D7ucoin.
...
pull request posted by [D7ucoinPullTester](https://github.com/D7ucoinPullTester). See https://github.com/TheBlueMatt/test-scripts
...
See https://github.com/d7ucoin/QA/ for how to create a test plan.

Translations
------------

Changes to translations as well as new translations can be submitted to
[D7ucoin Core's Transifex page](https://www.transifex.com/projects/p/d7ucoin/).
...
Translators should also subscribe to the [mailing list](https://groups.google.com/forum/#!forum/d7ucoin-translators).
